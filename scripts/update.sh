...
version=`curl --silent "https://api.github.com/repos/yamafaktory/jql/releases/latest" | jq .tag_name | xargs`
revision=`curl --silent "https://api.github.com/repos/yamafaktory/jql/commits/${version}" | jq .sha | xargs`
version=${version#"v"}
